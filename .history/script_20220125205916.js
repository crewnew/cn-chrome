     ...
     manager {
      ...
      fetch("https://apps.crewnew.com/v1/graphql", {
        ...
        .then((data) => {
          ...
          e.innerHTML = `<div style="position:fixed;right:0;top:50%;transform:translateX(-50%);background-color:red;z-index:999;padding:1rem 2rem;border-radius:10px;">${user.id}</div>`;
