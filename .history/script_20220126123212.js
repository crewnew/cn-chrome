...
const fetchDataAndSetPopupInformation = (formattedUrl) => {
  fetch("https://apps.crewnew.com/v1/graphql", {
    ...
    .then((data) => {
      ...
      userDiv.style.cssText = `position:fixed;left:5px;top:50%;transform:translateY(-50%);background-color:#fff;z-index:999;padding:1rem 2rem;border-radius:10px;box-shadow: 0 0 5px 1px;`;
